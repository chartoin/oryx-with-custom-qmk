...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(
        ...
        KC_I, KC_O, KC_P, KC_BSLS, CW_TOGG, MT(MOD_LCTL, KC_A),
        MT(MOD_LALT, KC_S), MT(MOD_LSFT, KC_D), MT(MOD_LGUI, KC_F), LT(5, KC_G),
        ...
        KC_Z, KC_X, KC_C, LT(3, KC_V), KC_B, KC_N, LT(3, KC_M), KC_COMMA,
        KC_DOT, KC_SLASH, KC_TRANSPARENT, TT(2), KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, MO(1), TD(DANCE_0), KC_ESCAPE, MO(1), KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_SPACE, KC_BSPC,
        MO(4), KC_SPACE, KC_TAB, KC_ENTER),
    [1] = LAYOUT_moonlander(
    ...
    [3] = LAYOUT_moonlander(
        ...
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, LALT(LGUI(LCTL(KC_GRAVE))), KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        ...
        KC_TRANSPARENT, KC_TRANSPARENT, KC_BSPC, KC_DELETE, KC_TRANSPARENT,
        ...
        KC_TRANSPARENT, KC_PSCR, KC_DELETE, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    ...
    [5] = LAYOUT_moonlander(
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_SLASH, TD(DANCE_3), KC_MINUS,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_7, KC_8, KC_9, TD(DANCE_4),
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
